...
Rectilinear::Rectilinear()
    : mId(-1), mName(""), mType(rectilinearType::EMPTY), 
    mLegalArea(0), mGlobalPlacement(Rectangle(0, 0, 0, 0)),
    mAspectRatioMin(0), mAspectRatioMax(std::numeric_limits<double>::max()), mUtilizationMin(0){
}
...
Rectilinear::Rectilinear(int id, std::string name, rectilinearType type, Rectangle initPlacement,
    ...
    mLegalArea(minArea), mGlobalPlacement(initPlacement),
    mAspectRatioMin(aspectRatioMin), mAspectRatioMax(aspectRatioMax), mUtilizationMin(utilizationMin){
}

Rectilinear::Rectilinear(const Rectilinear &other)
    : mId(other.mId), mName(other.mName), mType(other.mType), 
    mLegalArea(other.mLegalArea), mGlobalPlacement(other.mGlobalPlacement),
    mAspectRatioMin(other.mAspectRatioMin), mAspectRatioMax(other.mAspectRatioMax), mUtilizationMin(other.mUtilizationMin){
...
Rectangle Rectilinear::getGlobalPhasePlacement() const {
